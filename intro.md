...
We'll be using Python 3 because it's free, powerful, full stack ([Python is the second-best language for everything](https://twitter.com/jakevdp/status/994934052091318272?lang=en)) and the lingua franca of data wrangling.  There may also be a little [SQL](https://www.sqlite.org/index.html).
...
![img0](https://halkyard.github.io/lh/assets/images/img0.png?raw=true)
[view](https://halkyard.github.io/lh/assets/images/img0.png)

### Next Steps

*    Read and complete the exercise in chapters 1 through 7 of [Automate the Boring Stuff with Python](https://automatetheboringstuff.com/)
